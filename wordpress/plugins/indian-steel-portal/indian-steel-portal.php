...
function indian_steel_portal_shortcode() {
    ...
    wp_enqueue_style('indian-steel-css', plugins_url('assets/index-DzSxOKno.css', __FILE__), array(), '1.2.0');
    wp_enqueue_script('indian-steel-js', plugins_url('assets/index-XMhlv4Kk.js', __FILE__), array(), '1.2.0', true);
