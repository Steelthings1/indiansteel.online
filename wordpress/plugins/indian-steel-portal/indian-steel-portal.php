...
function indian_steel_portal_shortcode() {
    ...
    wp_enqueue_style('indian-steel-css', plugins_url('assets/index-27YxBKEq.css', __FILE__), array(), '2.5.0');
    wp_enqueue_script('indian-steel-js', plugins_url('assets/index-bRmPvnLY.js', __FILE__), array(), '2.5.0', true);
