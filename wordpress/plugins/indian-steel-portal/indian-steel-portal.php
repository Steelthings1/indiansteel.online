...
function indian_steel_portal_shortcode() {
    ...
    wp_enqueue_style('indian-steel-css', plugins_url('assets/index-LzpiOz8m.css', __FILE__), array(), '2.7.0');
    wp_enqueue_script('indian-steel-js', plugins_url('assets/index-DH-hqGii.js', __FILE__), array(), '2.7.0', true);
