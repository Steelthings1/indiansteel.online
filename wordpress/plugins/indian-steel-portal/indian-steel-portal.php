...
function indian_steel_portal_shortcode() {
    ...
    wp_enqueue_style('indian-steel-css', plugins_url('assets/index-DOnOFavP.css', __FILE__), array(), '3.0.0');
    wp_enqueue_script('indian-steel-js', plugins_url('assets/index-BeHh7gDV.js', __FILE__), array(), '3.0.0', true);
