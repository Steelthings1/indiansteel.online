...
function indian_steel_portal_shortcode() {
    ...
    wp_enqueue_style('indian-steel-css', plugins_url('assets/index-CXn1TsLU.css', __FILE__), array(), '1.5.0');
    wp_enqueue_script('indian-steel-js', plugins_url('assets/index-DHJCcS2w.js', __FILE__), array(), '1.5.0', true);
