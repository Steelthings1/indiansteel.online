...
function indian_steel_portal_shortcode() {
    ...
    wp_enqueue_style('indian-steel-css', plugins_url('assets/index-Dv_A-9w0.css', __FILE__), array(), '2.6.0');
    wp_enqueue_script('indian-steel-js', plugins_url('assets/index-B1dT7jDv.js', __FILE__), array(), '2.6.0', true);
