...
function indian_steel_portal_shortcode() {
    ...
    wp_enqueue_style('indian-steel-css', plugins_url('assets/index-rU2z8SqN.css', __FILE__), array(), '2.2.0');
    wp_enqueue_script('indian-steel-js', plugins_url('assets/index-EWJ6sP19.js', __FILE__), array(), '2.2.0', true);
