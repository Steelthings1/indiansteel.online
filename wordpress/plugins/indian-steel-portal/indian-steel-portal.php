...
function indian_steel_portal_shortcode() {
    ...
    wp_enqueue_style('indian-steel-css', plugins_url('assets/index-BT0AWsXC.css', __FILE__), array(), '2.9.0');
    wp_enqueue_script('indian-steel-js', plugins_url('assets/index-Bu9iFv-H.js', __FILE__), array(), '2.9.0', true);
