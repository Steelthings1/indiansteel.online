...
function indian_steel_portal_shortcode() {
    ...
    wp_enqueue_style('indian-steel-css', plugins_url('assets/index-C0k0UC5V.css', __FILE__), array(), '2.0.0');
    wp_enqueue_script('indian-steel-js', plugins_url('assets/index-D8gYuw2z.js', __FILE__), array(), '2.1.0', true);
