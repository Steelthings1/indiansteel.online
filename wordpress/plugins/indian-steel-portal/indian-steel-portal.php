...
function indian_steel_portal_shortcode() {
    ...
    wp_enqueue_style('indian-steel-css', plugins_url('assets/index-BBKBLiaa.css', __FILE__), array(), '1.9.0');
    wp_enqueue_script('indian-steel-js', plugins_url('assets/index-UQ1BOis8.js', __FILE__), array(), '1.9.0', true);
