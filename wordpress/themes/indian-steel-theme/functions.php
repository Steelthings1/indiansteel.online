...
function indian_steel_enqueue_scripts() {
    ...
    wp_enqueue_style('indian-steel-app-css', get_template_directory_uri() . '/assets/index-DyVQ9eUR.css', array(), '1.6.0');

    // Production Bundled JS (React SPA)
    wp_enqueue_script('indian-steel-app-js', get_template_directory_uri() . '/assets/index-Bpy8NgBX.js', array(), '1.6.0', true);
}
