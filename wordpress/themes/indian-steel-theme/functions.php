...
function indian_steel_enqueue_scripts() {
    ...
    wp_enqueue_style('indian-steel-app-css', get_template_directory_uri() . '/assets/index-D4DaCWZq.css', array(), '2.8.0');

    // Production Bundled JS (React SPA)
    wp_enqueue_script('indian-steel-app-js', get_template_directory_uri() . '/assets/index-uxu5GawI.js', array(), '2.8.0', true);
}
