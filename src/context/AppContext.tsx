...
const initialProducts: Product[] = [
  {
    id: 'prod-1',
    name: 'MS Plate (IS 2062 E250)',
    category: 'MS Plates',
    description: 'High-grade Mild Steel plates suitable for general engineering, structural fabrication, industrial machinery bases, and heavy construction.',
    applications: ['Structural Columns', 'Machine Base Plates', 'Heavy Earthmoving Parts', 'Building Girders', 'Flanges & Brackets'],
    thicknesses: ['6 mm', '8 mm', '10 mm', '12 mm', '16 mm', '20 mm', '25 mm', '32 mm', '50 mm'],
    grades: ['IS 2062 E250 A/B', 'IS 2062 E350'],
  ...
  },
  {
    ...
    category: 'MS Sheets',
    description: 'Precision-rolled mild steel sheets with smooth surface finish for enclosures, panels, automotive components, and ducting.',
    applications: ['Control Panels', 'Electrical Boxes', 'Automotive Bodies', 'Ducting & Storage Tanks', 'Cabinet Fabrication'],
    thicknesses: ['1.2 mm', '1.6 mm', '2.0 mm', '2.5 mm', '3.0 mm', '4.0 mm', '5.0 mm'],
    grades: ['HR Grade', 'CR Grade 1'],
  ...
  {
    id: 'prod-3',
    name: 'Custom Shape Cut Plates & Flanges',
    category: 'Custom Steel Pieces',
    description: 'Cut-to-spec custom mild steel shapes including circular discs, gear blanks, pipe flanges, gussets, and anchor plates.',
    applications: ['Pipe Connection Flanges', 'Gear Blanks', 'Crane Hook Parts', 'Base Gussets', 'Special Machine Parts'],
    thicknesses: ['8 mm', '12 mm', '16 mm', '25 mm', '40 mm', '60 mm'],
  ...
  },
  {
    ...
    description: 'Durable anti-skid chequered steel plates engineered for industrial flooring, stair treads, platform walkways, and heavy ramps.',
    applications: ['Factory Walkways', 'Stair Treads', 'Truck Bed Liners', 'Scaffolding Decks', 'Heavy Access Ramps'],
